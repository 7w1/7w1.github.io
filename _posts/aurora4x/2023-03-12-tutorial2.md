...
Lastly, click the number (5 in the image below) and type in a number reflecting the colonies priority.

Finally, click **Assign Colony Governor** to automatically assign one with your specified bonuses.

> If no governor appeared, it means the game couldn't find one matching your requirements. Try switching around the bonuses or reducing your priority number.
{: .prompt-warning }
