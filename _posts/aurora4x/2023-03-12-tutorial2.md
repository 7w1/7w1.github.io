...
tags: [Aurora 4x, industry, research, military academy, shipyard, governor]
---
# Starting the game
...
**Military Academies** are how you gain more officers and administrators which you will need to pilot ships and manage colonies.
...
You have changed the scientist's field, now you can queue up your research (if you haven't already) or continue onto the next section.
...
Then, you'll want to select the bonuses you want. I chose **Mining**, **Wealth Creation**, and **Shipbuilding**

Lastly, click the number (5 in the image below) and type in the minimum bonus for the top bonus category (**Mining** for me). You can see on the left that I managed to get one with a bonus of 25%, despite only requiring 5%.

Finally, click **Assign Colony Governor** to automatically assign one with your specified bonuses.

> If no governor appeared, it means the game couldn't find one matching your requirements. Try switching around the bonuses or reducing your required bonus amount.
{: .prompt-warning }
...
Ready for more? Click [here](https://7w1.github.io/posts/tutorial2/) (Part 3 coming soon!)